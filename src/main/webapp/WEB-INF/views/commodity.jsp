...
<body>
	<div class="container">
		<div class="row">
			<div class="col-12">
				<form:form action="/admin/commodity" method="POST"
					...
					<div class="form-group row">
						<label class="col-2 col-form-label" for="category">Category:
						</label>
						<div class="col-10">
					...
					<c:forEach var="commodity" items="${commodities}">
						<tr>
							...
							<td class="text-center"><a
								href="/admin/commodity/update/${commodity.id}"
								class="btn btn-outline-warning btn-sm">Update</a> <a
								href="/admin/commodity/delete/${commodity.id}"
